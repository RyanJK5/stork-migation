...
<dependency>
    ...
    <version>{cdi:extra.version.current}</version>
</dependency>
<dependency>
    <groupId>io.smallrye.stork</groupId>
...
```java linenums="1"
{#include 'examples/AcmeServiceDiscoveryProvider.java' /}
```
...
```java linenums="1"
{#include 'examples/AcmeServiceDiscovery.java' /}
```
...
```java linenums="1"
{#include 'examples/AcmeDiscoveryApiUsage.java' /}
```
...
```java linenums="1"
{#include 'examples/CustomExpirationCachedAcmeServiceDiscovery.java' /}
```
