...
{#diagram language="plantuml" alt="Stork concepts" width=1075 height=364 diagramOutputFormat="svg"}
{#include diagrams/stork.puml /}
{/}
...
{#diagram language="plantuml" alt="Service discovery and selection" width=961 height=493 diagramOutputFormat="svg"}
...
```java linenums="1"
{#include examples/InitializationExample.java /}
```
...
```java linenums="1"
{#include 'examples/StorkServiceExample.java' /}
```
...
```java linenums="1"
{#include 'examples/StorkServiceLookupExample.java' /}
```
...
```java linenums="1"
{#include 'examples/StorkServiceSelectionExample.java' /}
```
